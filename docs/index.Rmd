...
En esta nota, nosotros mostramos cómo usamos el _web scrapping_ para extraer los datos de los momios de la [Liga MX](https://sports.caliente.mx/es_MX/Liga-MX) y [La Liga](https://sports.caliente.mx/es_MX/La-Liga), con el fin de (en una siguiente nota) hacer una comparación con los resultados del [modelo de predicciones del NIES](https://predictions-nies.streamlit.app/).
